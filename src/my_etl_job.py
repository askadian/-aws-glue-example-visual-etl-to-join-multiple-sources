...
Planassignment_node1685352066932 = glueContext.create_dynamic_frame.from_options(format_options={"quoteChar": "\"", "withHeader": True, "separator": ",", "optimizePerformance": False}, connection_type="s3", format="csv", connection_options={"paths": ["s3://aws-bigdata-blog/artifacts/telco-data-monetization-configs-us-east-1/data/customer_subscription_map_20190501.csv.gz"], "recurse": True}, transformation_ctx="Planassignment_node1685352066932")

# Script generated for node Plans
Plans_node1685352206564 = glueContext.create_dynamic_frame.from_options(format_options={"quoteChar": "\"", "withHeader": True, "separator": ",", "optimizePerformance": False}, connection_type="s3", format="csv", connection_options={"paths": ["s3://aws-bigdata-blog/artifacts/telco-data-monetization-configs-us-east-1/data/tariff_plan_desc_20190501.csv.gz"], "recurse": True}, transformation_ctx="Plans_node1685352206564")

# Script generated for node Subscribers
Subscribers_node1 = glueContext.create_dynamic_frame.from_options(format_options={"quoteChar": "\"", "withHeader": True, "separator": ",", "optimizePerformance": False}, connection_type="s3", format="csv", connection_options={"paths": ["s3://aws-bigdata-blog/artifacts/telco-data-monetization-configs-us-east-1/data/crm_demographics_20190501.csv.gz"], "recurse": True}, transformation_ctx="Subscribers_node1")
...
Catalog_node1685352920969 = glueContext.getSink(path="s3://aws-glue-example-visual-etl-to-join-multiple-sources/example/subscriber_plans/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=["plan_id"], enableUpdateCatalog=True, transformation_ctx="Catalog_node1685352920969")
